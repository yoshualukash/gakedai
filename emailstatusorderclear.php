...
$mail->Subject = 'Order Pesanan anda selesai diantar!';
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif;">
                                <h1 style="font-size: 24px; margin: 0; text-align: center;"> Hi, ' . $name . '! Order pesanan anda
                                    dengan </h1>
                                <ul>
                                    <h1 style="text-align: center;">Order ID : #' . $id_order . '</h1>
                                </ul>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">sudah selesai diantar!
                                </h1>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">Terima kasih telah memesan di GAKedai!</h1>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">Selamat menikmati pesanan anda!</h1>
                            </td>
                        </tr>
                    </table>
                </td>
