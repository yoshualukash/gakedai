...
$mail->Subject = 'Pesanan telah anda batalkan!';
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif;">
                                ...
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">telah anda batalkan!
                                </h1>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">Silahkan memesan kembali di GAKedai!</h1>
...
// Kirim email
if ($mail->send()) {
    echo "<script>window.location.assign('myorder.php')</script>";
}
