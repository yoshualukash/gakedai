...
$mail->Subject = 'Welcome to GAKedai Kafe!';
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif;">
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">Selamat datang di
                                    GAKedai, ' . $name . '!</h1>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">Terima kasih telah
                                    mendaftar!</h1>
                            </td>
                        </tr>
                    </table>
