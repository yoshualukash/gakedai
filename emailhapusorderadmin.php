...
$mail->Subject = 'Maaf pesanan anda kami batalkan!';
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif;">
                                <h1 style="font-size: 24px; margin: 0; text-align: center;"> Hi, ' . $name . '! Order Pesanan anda </h1>
                                <ul>
                                    <h1 style="text-align: center;">Order ID : #' . $id_order . '</h1>
                                </ul>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">kami batalkan!
                                </h1>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">Mohon maaf atas ketidaknyamanannya. Harap menghubungi nomor wa kami 082216343083 jika sudah terlanjur membayar.</h1>
