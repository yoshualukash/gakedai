...
$mail->Subject = 'Order Pesanan anda sedang diantar!';
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif;">
                                ...
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">sedang diantar!
                                </h1>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">Harap menunggu sekitar 15-45 menit dari sekarang!</h1>
                            </td>
                        </tr>
                    </table>
                </td>
