...
$mail->Subject = 'Bukti bayar order telah kami verifikasi!';
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif;">
                                <h1 style="font-size: 24px; margin: 0; text-align: center;"> Hi, ' . $name . '! Bukti bayar order anda
                                    dengan </h1>
                                <ul>
                                    <h1 style="text-align: center;">Order ID : #' . $id_order . '</h1>
                                </ul>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">telah kami verifikasi!
                                </h1>
                                <h1 style="font-size: 24px; margin: 0; text-align: center;">Pesanan anda sedang
                                    dibuat, harap sabar menunggu!</h1>
                            </td>
                        </tr>
                    </table>
                </td>
