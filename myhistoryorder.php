    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <h1 class="mb-2 bread">History Order</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="profile.php">Profile </a><i class="ion-ios-arrow-forward"></i></span></span><span>History Order <i class="ion-ios-arrow-forward"></i></span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container ftco-animate">
        <div class="row justify-content-center mb-5 pb-2">
            <div class="col-md-7 text-center heading-section ftco-animate">
                ...
                <h2 class="mb-4">History Order <?php echo $username; ?></h2>
            </div>
        </div>
        <div class='row'>
            <div class='col-md-12'>
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Waktu Order Selesai</th>
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM daftar_order WHERE id_pelanggan='$id_user' AND status_tracking='3'";
                            ...
                            while ($row = mysqli_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <!-- Bukti Bayar -->
                                    <td>
                                        <b><?php echo $row['waktu_selesai']; ?></b>
                                    </td>
